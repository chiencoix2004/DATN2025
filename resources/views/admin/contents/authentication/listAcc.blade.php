                ...
                <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                    ...
                    <tbody class="list" id="table-customers-body">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input class="form-check-input"
                                        type="checkbox" id="customer-1" data-bulk-select-row="data-bulk-select-row" />
                                </div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="email align-middle py-2"><a href="mailto:emma@example.com">emma@example.com</a>
                            </td>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-2"
                            ...
                            <td class="email align-middle py-2"><a href="mailto:rown@example.com">rown@example.com</a>
                            </td>
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:2012001851">(201)
                                    200-1851</a></td>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-3"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-4"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-5"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-6"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:3026138829">(302)
                                    613-8829</a></td>
                            <td class="address align-middle white-space-nowrap ps-5 py-2">4678 Maud Street, Philadelphia,
                                DE 19103</td>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-7"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-8"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-9"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-10"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-11"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                                        <div class="avatar avatar-xl me-2">
                                            <img class="rounded-circle" src="../../assets/img/team/14.jpg"
                                                alt="" />
                                        </div>
                                        <div class="flex-1">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-12"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-13"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:2029984702">(202)
                                    998-4702</a></td>
                            <td class="address align-middle white-space-nowrap ps-5 py-2">91979 Kohler Place
                                Waelchiborough, CT 41291</td>
                            <td class="joined align-middle py-2">23/04/2019</td>
                            <td class="align-middle white-space-nowrap py-2 text-end">
                                <div class="dropdown font-sans-serif position-static"><button
                                        class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button"
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-14"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-15"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="email align-middle py-2"><a href="mailto:haag@example.com">haag@example.com</a>
                            </td>
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:2459881927">(245)
                                    988-1927</a></td>
                            <td class="address align-middle white-space-nowrap ps-5 py-2">2327 Kaylee Mill East Citlalli,
                                AZ 89582-3143</td>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-16"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-17"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-18"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-19"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:5056977549">(505)
                                    697-7549</a></td>
                            <td class="address align-middle white-space-nowrap ps-5 py-2">4167 Laverna Manor Marysemouth,
                                NV 74590</td>
                            <td class="joined align-middle py-2">26/04/2019</td>
                            <td class="align-middle white-space-nowrap py-2 text-end">
                                <div class="dropdown font-sans-serif position-static"><button
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-20"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="email align-middle py-2"><a href="mailto:howe@example.com">howe@example.com</a>
                            </td>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-21"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-22"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-23"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="align-middle py-2" style="width: 28px;">
                                <div class="form-check fs-9 mb-0 d-flex align-items-center"><input
                                        class="form-check-input" type="checkbox" id="customer-24"
                                        data-bulk-select-row="data-bulk-select-row" /></div>
                            </td>
                            <td class="name align-middle white-space-nowrap py-2"><a href="customer-details.html">
                                    <div class="d-flex d-flex align-items-center">
                            ...
                            <td class="phone align-middle white-space-nowrap py-2"><a href="tel:4018799970">(401)
                                    879-9970</a></td>
                            <td class="address align-middle white-space-nowrap ps-5 py-2">Garry Brainstrow, 13572 Kurt
                                Mews South Merritt, IA 52491</td>
                            <td class="joined align-middle py-2">23/04/2019</td>
                            <td class="align-middle white-space-nowrap py-2 text-end">
                                <div class="dropdown font-sans-serif position-static"><button
                                        class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal" type="button"
