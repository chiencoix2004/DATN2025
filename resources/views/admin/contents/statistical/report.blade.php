...
<div class="d-flex mb-4 mt-3"><span class="fa-stack me-2 ms-n1"><i class="fas fa-circle fa-stack-2x text-300"></i><i class="fa-inverse fa-stack-1x text-primary fas fa-percentage"></i></span>
    ...
    <div class="col-xxl-4 col-md-6">
      <div class="card h-100 bg-line-chart-gradient">
        ...
        <div class="card-body text-white fs-10 pb-0" data-bs-theme="light">
          <p class="border-bottom pb-2" style="border-color: rgba(255, 255, 255, 0.15) !important">Page views / second</p><!-- Find the JS file for the following chart at: src/js/charts/echarts/real-time-users.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
  ...
  <div class="row g-3 mb-3">
    ...
    <div class="col-md-6 col-xxl-4">
      <div class="card">
        ...
        <div class="card-body"><!-- Find the JS file for the following chart at: src/js/charts/echarts/session-by-country-map.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
          <div class="echart-session-by-country-map w-100 h-100" data-echart-responsive="true"></div><!-- Find the JS file for the following chart at: src/js/charts/echarts/session-by-country.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
              ...
              <table class="table table-borderless fs-10 fw-medium mb-0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="p-1"><a class="text-600 text-decoration-none" href="mailto:goodguy@nicemail.com">goodguy@nicemail.com </a><small class="badge rounded badge-subtle-success false">Verified</small></td>
                  </tr>
                  <tr>
                    <td class="p-1" style="width: 35%;">Mobile No:</td>
                    <td class="p-1"><a class="text-600 text-decoration-none" href="tel:+01234567890 ">+012-345-67890 </a><small class="badge rounded badge-subtle-primary false">2-step verification</small></td>
                  </tr>
                </tbody>
              </table>
        ...
        <div class="col-md-6">
          <div class="card font-sans-serif">
            ...
            <div class="card-body">
              <div class="row g-0">
                <div class="col-6">
                  <h4 class="text-700 lh-1 mb-1"> $1971.52</h4><small class="badge rounded badge-subtle-danger false">5.1% last month</small>
                </div>
        ...
        <div class="col-md-6">
          <div class="card font-sans-serif">
            ...
            <div class="card-body">
              <div class="row g-0">
                <div class="col-6">
                  <h4 class="text-700 lh-1 mb-1"> 121h 11m</h4><small class="badge rounded badge-subtle-success false">3.6% last month</small>
                </div>
                <div class="col-6 mt-n4 d-flex justify-content-end">
            ...
            <div class="col-sm-7 order-1 order-sm-0">
              <div class="row g-sm-0 gy-4 row-cols-2 h-100 align-content-between">
                <div class="col">
                  ...
                  <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-success false">2.1%</small></h6>
                </div>
                <div class="col">
                  <div class="d-flex gap-2 mb-3">
                  ...
                  <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-danger false">5.1%</small></h6>
                </div>
                <div class="col">
                  <div class="d-flex gap-2 mb-3">
                  ...
                  <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-secondary dark__bg-1000">0.0%</small></h6>
                </div>
                <div class="col">
                  <div class="d-flex gap-2 mb-3">
                  ...
                  <h6 class="mb-0"><span class="text-500 me-2">this week</span><small class="badge rounded badge-subtle-primary false">3.5%</small></h6>
                </div>
              </div>
            </div>
  ...
  <div class="row g-3 mb-3">
    <div class="col-12 col-md-6 col-xxl-4">
      <div class="card h-100 h-100">
        ...
        <div class="card-body"><!-- Find the JS file for the following chart at: src/js/charts/echarts/bounce-rate.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
    ...
    <div class="col-12 col-md-6 col-xxl-4 order-xxl-1">
      <div class="card">
        ...
        <div class="card-body"><!-- Find the JS file for the following chart at: src/js/charts/echarts/users-by-time.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
    ...
    <div class="col-12 col-xxl-8">
      <div class="card">
        ...
        <div class="card-body"><!-- Find the JS file for the following chart at: src/js/charts/echarts/traffic-channels.js--><!-- If you are not using gulp based workflow, you can find the transpiled code at: public/assets/js/theme.js-->
            ...
            <table class="table fs-10 mb-0">
              ...
              <tbody class="list">
                <tr class="fw-semi-bold">
                  ...
                  <td class="align-middle pe-x1 text-end native-support"><small class="badge rounded badge-subtle-undefined false"></small></td>
                </tr>
                <tr class="fw-semi-bold">
                  <td class="align-middle py-3"><a href="#!">
    ...
    <div class="col-xxl-8">
      <div class="card">
        <div class="card-header d-flex flex-between-center">
          ...
          <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-project-statistics" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
        ...
        <table class="table table-sm fs-10 mb-0 overflow-hidden">
          ...
          <tbody class="list" id="table-purchase-body">
            ...
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle text-center fs-9 white-space-nowrap payment"><small class="badge rounded badge-subtle-secondary dark__bg-1000">Blocked</small></td>
            ...
            <tr class="btn-reveal-trigger">
              ...
              <td class="align-middle text-center fs-9 white-space-nowrap payment"><small class="badge rounded badge-subtle-warning false">Pending</small></td>
        ...
        <div class="card-body pb-0">
          ...
          <div class="d-flex mb-3 hover-actions-trigger align-items-center">
            ...
            <div class="ms-3 flex-shrink-1 flex-grow-1">
              ...
              <div class="fs-10"><span class="fw-semi-bold">Anna</span><span class="fw-medium text-600 ms-2">5 Oct at 4:30 PM</span></div>
              <div class="hover-actions end-0 top-50 translate-middle-y"><a class="btn btn-tertiary border-300 btn-sm me-1 text-600" data-bs-toggle="tooltip" data-bs-placement="top" title="Download" href="assets/img/icons/cloud-download.svg" download="download"><img src="assets/img/icons/cloud-download.svg" alt="" width="15" /></a><button class="btn btn-tertiary border-300 btn-sm me-1 text-600 shadow-none" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><img src="assets/img/icons/edit-alt.svg" alt="" width="15" /></button></div>
            </div>
          </div>
        </div>
        ...
        <div class="card-header">
          <div class="row flex-between-center">
            ...
            <div class="col-auto col-sm-6 col-lg-5">
              <div>
                <form>
                  <div class="input-group"><input class="form-control form-control-sm shadow-none search" type="search" placeholder="Search for a page" aria-label="search" /><button class="btn btn-sm btn-outline-secondary border-300 hover-border-secondary"><span class="fa fa-search fs-10"></span></button></div>
                </form>
              </div>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body p-0">
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-0" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
          ...
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-1" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
          ...
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-2" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
          ...
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-3" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
          ...
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-4" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
          ...
          <div class="d-flex justify-content-between border-top hover-actions-trigger btn-reveal-trigger px-x1 border-200 todo-list-item">
            ...
            <div class="d-flex align-items-center">
              <div class="hover-actions"><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-clock"></span></button><button class="btn btn-tertiary icon-item rounded-3 me-2 fs-11 icon-item-sm"><span class="fas fa-user-plus"></span></button></div>
              <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal-sm transition-none" type="button" id="management-to-do-list-5" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
    ...
    <div class="col-lg-4">
      <div class="card h-100">
        <div class="card-header bg-body-tertiary py-2 d-flex flex-between-center">
          ...
          <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-members-activity" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
        ...
        <div class="card-header border-bottom border-200 px-0">
          <div class="d-lg-flex justify-content-between">
            <div class="row flex-between-center gy-2 px-x1">
              ...
              <div class="col-auto">
                <form>
                  <div class="input-group input-search-width"><input class="form-control form-control-sm shadow-none" type="search" placeholder="Search  by name" aria-label="search" /><button class="btn btn-sm btn-outline-secondary border-300 hover-border-secondary"><span class="fa fa-search fs-10"></span></button></div>
                </form>
              </div>
            </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/1.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Apple MacBook Pro 15&quot; Z0V20008N: 2.9GHz 6-core 8th-Gen Intel Core i9, 32GB RAM</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
        <div class="col-4 py-3 px-x1">
          <div class="row align-items-center">
            <div class="col-md-8 d-flex justify-content-end justify-content-md-center order-1 order-md-0">
              <div>
                <div class="input-group input-group-sm flex-nowrap" data-quantity="data-quantity"><button class="btn btn-sm btn-outline-secondary border-300 px-2 shadow-none" data-type="minus">-</button><input class="form-control text-center px-2 input-spin-none" type="number" min="1" value="1" aria-label="Amount (to the nearest dollar)" style="width: 50px" /><button class="btn btn-sm btn-outline-secondary border-300 px-2 shadow-none" data-type="plus">+</button></div>
              </div>
            </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/2.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Apple iMac Pro (27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB SSD)</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/4.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Apple iPad Air 2019 (3GB RAM, 128GB ROM, 8MP Main Camera)</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/3.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Apple iPhone XS Max (4GB RAM, 512GB ROM, 12MP Main Camera)</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/5.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Apple Watch Series 4 44mm GPS Only</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/7.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Nikon D3200 Digital DSLR Camera</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row gx-x1 mx-0 align-items-center border-bottom border-200">
        <div class="col-8 py-3 px-x1">
          <div class="d-flex align-items-center"><a href="app/e-commerce/product/product-details.html"><img class="img-fluid rounded-1 me-3 d-none d-md-block" src="assets/img/products/8.jpg" alt="" width="60" /></a>
            <div class="flex-1">
              <h5 class="fs-9"><a class="text-900" href="app/e-commerce/product/product-details.html">Canon Standard Zoom Lens</a></h5>
              <div class="fs-11 fs-md--1"><a class="text-danger" href="#!">Remove</a></div>
            </div>
          </div>
        </div>
      ...
      <div class="row fw-bold gx-x1 mx-0">
        ...
        <div class="col px-0">
          <div class="row gx-x1 mx-0">
            <div class="col-md-8 py-2 px-x1 d-none d-md-block text-center">7 (items)</div>
  ...
  <div class="row g-3 mb-3">
    <div class="col-lg-6">
      <div class="card h-100">
        ...
        <div class="card-body bg-body-tertiary"><select class="form-select mb-3" aria-label="Default select example">
          ...
          <div class="d-flex justify-content-between fs-10 mb-1 text-success">
          ...
          <p class="fs-10 text-600">Once you start your trial, you will have 30 days to use Falcon Premium for free. After 30 days you’ll be charged based on your selected plan.</p><button class="btn btn-primary d-block w-100" type="submit"><span class="fa fa-lock me-2"></span>Start free trial</button>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header bg-body-tertiary d-flex flex-between-center">
          <h5 class="mb-0">Order Summary</h5><a class="btn btn-falcon-default btn-sm text-600" href="app/e-commerce/shopping-cart.html"><span class="fas fa-pencil-alt"></span></a>
        </div>
        <div class="card-body">
          <table class="table table-borderless fs-10 mb-0">
            <tr class="border-bottom">
              <th class="ps-0 pt-0">Apple MacBook Pro 15" x 1<div class="text-400 fw-normal fs-11">Z0V20008N: 2.9GHz 6-core 8th-Gen Intel Core i9, 32GB RAM</div>
              </th>
              <th class="pe-0 text-end pt-0">$1345</th>
            </tr>
            <tr class="border-bottom">
              <th class="ps-0">Apple iMac Pro x 1<div class="text-400 fw-normal fs-11">27-inch with Retina 5K Display, 3.0GHz 10-core Intel Xeon W, 1TB</div>
              </th>
  ...
  <div class="row g-0 align-items-stretch h-100">
    ...
    <div class="col-lg-6 ps-lg-2 mb-3">
      <div class="card h-100">
        ...
        <div class="card-footer bg-body-tertiary py-0 border-top"><a class="btn btn-link d-block w-100" href="app/social/notifications.html">All Notifications</a></div>
      </div>
    </div>
  </div>
  <div class="row g-0">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/mailbluster.png" alt="" width="50" />
                <div class="flex-1">
                  <h6 class="fs-9 mb-0"><a class="stretched-link" href="#!">Mailbluster</a></h6>
            ...
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/digitalocean.png" alt="" width="50" />
                <div class="flex-1">
                  <h6 class="fs-9 mb-0"><a class="stretched-link" href="#!">Digital Ocean</a></h6>
            ...
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/nvidia.png" alt="" width="50" />
                <div class="flex-1">
                  <h6 class="fs-9 mb-0"><a class="stretched-link" href="#!">Nvidia</a></h6>
            ...
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/hp.png" alt="" width="50" />
                <div class="flex-1">
                  <h6 class="fs-9 mb-0"><a class="stretched-link" href="#!">Hewlett Packard</a></h6>
            ...
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="d-flex position-relative align-items-center mb-2"><img class="d-flex align-self-center me-2 rounded-3" src="assets/img/logos/spotify.png" alt="" width="50" />
                <div class="flex-1">
                  <h6 class="fs-9 mb-0"><a class="stretched-link" href="#!">Spotify</a></h6>
            ...
            <div class="col">
              <form>
                <div class="row g-0">
                  ...
                  <div class="col d-md-block d-none"><select class="form-select form-select-sm ms-2" aria-label=".form-select-sm example">
          ...
          <div class="row g-0 text-center fs-10">
            ...
            <div class="col-6 col-md-4">
              <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/5.jpg" alt="" width="100" /></a>
                <h6 class="mb-1"><a href="pages/user/profile.html">Nikolaj Coster</a></h6>
            ...
            <div class="col-6 col-md-4">
              <div class="bg-white dark__bg-1100 p-3 h-100"><a href="pages/user/profile.html"><img class="img-thumbnail img-fluid rounded-circle mb-3 shadow-sm" src="assets/img/team/6.jpg" alt="" width="100" /></a>
                <h6 class="mb-1"><a href="pages/user/profile.html">Isaac Hempstead</a></h6>
    ...
    <div class="col-lg-5 ps-lg-2 mb-3">
      <div class="card h-100">
        <div class="card-body text-center py-5">
          ...
          <h3 class="mt-3 fw-normal fs-7">Invite a friend, you both get $100</h3>
          <p class="lead mb-5">Invite your friends and start working together in seconds. Everyone you invite will receive a welcome email.</p>
          <div class="row justify-content-center">
            <div class="col">
              <form class="row gx-2">
                <div class="col-sm mb-2 mb-sm-0"><input class="form-control" type="email" placeholder="Email address" aria-label="Recipient's username" /></div>
        ...
        <div class="card-footer bg-body-tertiary text-center pt-4">
          <div class="row justify-content-center">
            <div class="col-11 col-sm-10">
              <h4 class="fw-normal mb-0 fs-8">More ways to <br class="d-sm-none" /> invite your friends</h4>
              <div class="row gx-2 my-4">
                <div class="col-12"><button class="btn btn-falcon-default d-block w-100 mb-2"><img src="assets/img/logos/gmail.png" width="20" alt="" /><span class="fw-medium ms-2">Invite from Gmail</span></button></div>
                <div class="col-12"><button class="btn btn-falcon-default d-block w-100 mb-2" data-bs-toggle="modal" data-bs-target="#copyLinkModal"><span class="fas fa-link text-700"></span><span class="fw-medium ms-2">Copy Link</span></button>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content overflow-hidden">
                        ...
                        <div class="modal-body bg-body-tertiary p-4">
                          <form><input class="form-control form-control-sm invitation-link" value="https://falcon.com/invited" /></form>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-12"><button class="btn btn-falcon-default d-block w-100 ms-0"><span class="fab fa-facebook-square text-facebook" data-fa-transform="grow-2"></span><span class="fw-medium ms-2">Share on Facebook</span></button></div>
              </div>
              <p class="mb-2 fs-10">Once you’ve invited friends, you can <a href="#!">view the status of your referrals</a><br class="d-none d-lg-block d-xxl-none" /> or visit our <a href="#!">Help Center </a>if you have any questions. </p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-lg-8">
          <h4 class="mb-1"> Anthony Hopkins<span data-bs-toggle="tooltip" data-bs-placement="right" title="Verified"><small class="fa fa-check-circle text-primary" data-fa-transform="shrink-4 down-2"></small></span></h4>
  ...
  <div class="card cover-image mb-3"><img class="card-img-top" src="assets/img/generic/13.jpg" alt="" /><input class="d-none" id="upload-cover-image" type="file" /><label class="cover-image-file-input" for="upload-cover-image"><span class="fas fa-camera me-2"></span><span>Change cover photo</span></label></div>
          ...
          <div class="card h-lg-100">
            <div class="card-body p-4 p-sm-5">
              <div class="row flex-between-center mb-2">
                ...
                <div class="col-auto fs-10 text-600"><span class="mb-0 undefined">Have an account?</span> <span><a href="pages/authentication/simple/login.html">Login</a></span></div>
              </div>
              <form>
          ...
          <div class="card">
            ...
            <div class="card-body p-4">
              <div class="row flex-between-center">
                ...
                <div class="col-auto fs-10 text-600"><span class="mb-0 fw-semi-bold">New User?</span> <span><a href="pages/authentication/simple/register.html">Create account</a></span></div>
              </div>
              <form>
                ...
                <div class="row flex-between-center">
                  ...
                  <div class="col-auto"><a class="fs-10" href="pages/authentication/split/forgot-password.html">Forgot Password?</a></div>
                </div>
      ...
      <div class="row g-0 h-100 align-items-stretch">
        <div class="col-lg-12 mb-3">
          <div class="card h-100">
            ...
            <div class="card-body bg-body-tertiary pb-0"><a class="mb-4 d-block d-flex align-items-center" href="#experience-form" data-bs-toggle="collapse" aria-expanded="true" aria-controls="experience-form"><span class="circle-dashed"><span class="fas fa-plus"></span></span><span class="ms-3">Add new experience</span></a>
                  ...
                  <div class="row" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"data":[{"name":"avatar.png","size":"54kb","url":"assets/img/team"}]}'>
                    ...
                    <div class="col-md">
                      <div class="dz-message dropzone-area px-2 py-3" data-dz-message="data-dz-message">
                        <div class="text-center"><img class="me-2" src="assets/img/icons/cloud-upload.svg" width="25" alt="" />Upload your profile picture<p class="mb-0 fs-10 text-400">Upload a 300x300 jpg image with <br />a maximum size of 400KB</p>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="mb-3"><label class="form-label" for="form-example-gender">Gender</label><select class="form-select" name="gender" id="form-example-gender">
                    <option value="">Select your gender ...</option>
                    <option value="Male">Male</option>
                    <option value="Female">Female</option>
                    <option value="Other">Other</option>
                  </select></div>
                <div class="mb-3"><label class="form-label" for="form-example-wizard-phone">Phone</label><input class="form-control" type="text" name="phone" placeholder="Phone" id="form-example-wizard-phone" /></div>
                <div class="mb-3"><label class="form-label" for="form-example-wizard-datepicker">Date of Birth</label><input class="form-control datetimepicker" type="text" placeholder="dd/mm/yy" data-options='{"dateFormat":"dd/mm/yy","disableMobile":true}' id="form-example-wizard-datepicker" /></div>
                <div class="mb-3"><label class="form-label" for="form-example-wizard-address">Address</label><textarea class="form-control" rows="4" id="form-example-wizard-address"></textarea></div>
              </form>
            </div>
          </div>
        </div>
    ...
    <div class="col-lg-5 pe-lg-2 mb-3">
      <div class="card h-lg-100">
        <div class="card-body p-4 p-sm-5">
          ...
          <form class="mt-3">
            <div class="mb-3"><label class="form-label"></label><input class="form-control" type="password" placeholder="New Password" /></div>
            <div class="mb-3"><input class="form-control" type="password" placeholder="Confirm Password" /></div><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Set password</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <form class="card mb-3">
    ...
    <div class="card-body p-0">
      <div class="border border-top-0 border-200"><input class="form-control border-0 rounded-0 outline-none px-x1" id="email-to" type="email" aria-describedby="email-to" placeholder="To" /></div>
      ...
      <div class="min-vh-50 email-compose-textarea"><textarea class="tinymce d-none" data-tinymce="data-tinymce" name="content"></textarea></div>
      <div class="bg-body-tertiary px-x1 py-3">
        <div class="d-inline-flex flex-column">
          <div class="border px-2 rounded-3 d-flex flex-between-center bg-white dark__bg-1000 my-1 fs-10"><span class="fs-8 far fa-image"></span><span class="ms-2">winter.jpg (873kb)</span><a class="text-300 p-1 ms-6" href="#!" data-bs-toggle="tooltip" data-bs-placement="right" title="Detach"><span class="fas fa-times"></span></a></div>
          <div class="border px-2 rounded-3 d-flex flex-between-center bg-white dark__bg-1000 my-1 fs-10"><span class="fs-8 far fa-file-archive"></span><span class="ms-2">coffee.zip (342kb)</span><a class="text-300 p-1 ms-6" href="#!" data-bs-toggle="tooltip" data-bs-placement="right" title="Detach"><span class="fas fa-times"></span></a></div>
        </div>
      </div>
    </div>
    <div class="card-footer border-top border-200 d-flex flex-between-center">
      ...
      <div class="d-flex align-items-center">
        ...
        </div><button class="btn btn-tertiary btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="fas fa-trash"></span></button>
      </div>
    </div>
  </form>
  <div class="card mb-3">
            ...
            <div class="col-lg-8">
              ...
              <div class="dropdown"><button class="btn btn-link dropdown-toggle ps-0 btn-sm" id="change-plan" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Change plan</button>
                <div class="dropdown-menu py-3" aria-labelledby="change-plan" style="min-width: 15rem;">
                  <div class="dropdown-item px-3 py-2"><span class="d-flex justify-content-between fs-10 text-black"><span class="fw-semi-bold">Standard License</span><span>$59.00</span></span>
                    <ul class="list-unstyled ps-1 my-2 fs-10">
                    ...
                    <p class="fs-11 mb-0">Read the full <a href="#!">Standard License </a></p>
                  </div>
                  <div class="dropdown-divider my-0"></div>
                  <div class="dropdown-item px-3 py-2"><span class="d-flex justify-content-between fs-10 text-black"><span class="fw-semi-bold">Extended License</span><span>$99.00</span></span>
                    <ul class="list-unstyled ps-1 my-2 fs-10">
                    ...
                    <p class="fs-11 mb-0">Read the full <a href="#!">Extended License</a></p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-auto"><button class="btn btn-falcon-default btn-sm me-2">Save</button><button class="btn btn-falcon-primary btn-sm">Make your event live </button></div>
          </div>
        </div>
      </div>
      <div class="card">
    ...
    <div class="col-xl-7">
      <div class="card bg-transparent-50 overflow-hidden">
        <div class="card-header position-relative">
          <div class="bg-holder d-none d-md-block bg-card z-1" style="background-image:url(../assets/img/illustrations/ecommerce-bg.html);background-size:230px;background-position:right bottom;z-index:-1;"></div><!--/.bg-holder-->
    ...
    <div class="col-xl-5 col-xxl-4">
      <div class="row g-3">
        ...
        <div class="col-lg-3 col-xl-12">
          <div class="card h-100">
            <div class="bg-holder d-none d-xl-block bg-card" style="background-image:url(assets/img/icons/spot-illustrations/corner-4.png);opacity: 0.7;"></div><!--/.bg-holder-->
            <div class="card-body">
    ...
    <div class="col-xl-7 col-xxl-8">
      <div class="card h-100">
        <div class="card-header bg-body-tertiary d-flex flex-between-center">
          ...
          <div class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="documentations" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-10"></span></button>
      ...
      <div class="card h-100">
        ...
        <div class="card-body d-flex align-items-end">
          <div class="row g-3 justify-content-between">
            ...
            <div class="col-auto"><button class="btn btn-success w-100 fs-10" type="button"><span class="fas fa-video me-2"></span>Join meeting</button></div>
            <div class="col-auto ps-0">
      ...
      <div class="card">
        <div class="card-body p-4 p-sm-5">
          <div class="text-center"><img class="d-block mx-auto mb-4" src="assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
            ...
            <p>An email has been sent to <strong>xyz@abc.com</strong>. Please click on the included link to reset <span class="white-space-nowrap">your password.</span></p><a class="btn btn-primary btn-sm mt-3" href="pages/authentication/simple/login.html"><span class="fas fa-chevron-left me-1" data-fa-transform="shrink-4 down-1"></span>Return to login</a>
          </div>
        </div>
      </div>
    </div>
