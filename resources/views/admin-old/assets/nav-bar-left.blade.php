<nav class="section-menu-left">
    <div class="box-logo">
        <a href="{{ route('admin.dashboard') }}" id="site-logo-inner">
            <img class="" id="logo_header" alt="....." src="{{ asset('theme/admin/images/logo/logo.png') }}"
                data-light="{{ asset('theme/admin/images/logo/logo.png') }}"
                data-dark="{{ asset('theme/admin/images/logo/logo-dark.png') }}">
        </a>
    ...
    <div class="section-menu-left-wrap">
            ...
            <div class="center-item">
                ...
                <ul class="menu-list">
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.product.addProduct') }}" class="">
                                    <div class="text">Add Product</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.product.list') }}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.categories.list') }}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.attributes.listAttr') }}" class="">
                                    <div class="text">Attributes</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.attributes.addAttr') }}" class="">
                    ...
                    <li class="menu-item has-children">
                        ...
                        <ul class="sub-menu">
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.orders.list') }}" class="">
                                    <div class="text">Order list</div>
                                </a>
                            </li>
                            <li class="sub-menu-item">
                                <a href="{{ route('admin.orders.detail') }}" class="">
                            ...
                            <div class="icon">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_604_18468)">
                                        ...
                                        <path d="M19.0015 4.44801H15.5586V1L19.0015 4.44801Z" stroke="#111111"
        ...
        <div class="bot text-center">
            <div class="wrap">
                <div class="mb-20">
                    <img src="{{ asset('theme/admin/images/menu-left/img-bot.png') }}" alt="">
                </div>
                <div class="mb-20">
