...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="{{ asset('vendors/simplebar/simplebar.min.css') }}vendors/simplebar/simplebar.min.css" rel="stylesheet">
                                                ...
                                                <div class="row text-center gx-0 gy-0">
                                                    <div class="col-4"><a
                                                            ...
                                                            <div class="avatar avatar-2xl"> <img
                                                                    class="rounded-circle" src="assets/img/team/3.jpg"
                                                                    alt="" /></div>
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item"><!-- label-->
                                ...
                                </div><!-- parent pages--><a class="nav-link" href="app/calendar.html"
                                    role="button">
                                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                              ...
                              <li class="nav-item"><a class="nav-link dropdown-indicator" href="#category"
                              ...
                              <ul class="nav collapse" id="category">
                                  ...
                                  <li class="nav-item"><a class="nav-link"
                                          ...
                                          <div class="d-flex align-items-center"><span
                                                  class="nav-link-text ps-1">Category list</span></div>
                                      </a><!-- more inner pages--></li>

                                  <li class="nav-item"><a class="nav-link"
                                          href="{{route('admin.category.create')}}">
                                          <div class="d-flex align-items-center"><span
                                                  class="nav-link-text ps-1">Category add</span></div>
                                      </a><!-- more inner pages--></li>

                                  <li class="nav-item"><a class="nav-link"
                                          href="app/e-commerce/product/product-details.html">
                                          <div class="d-flex align-items-center"><span
                                                  class="nav-link-text ps-1">Category details</span></div>
                                      </a><!-- more inner pages--></li>
                              </ul>
                          </li>
