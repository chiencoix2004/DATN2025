        ...
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    <div class="col-md">
                        <h5 class="mb-2 mb-md-0"> mã giảm giá : {{ $coupon->name }}</h5>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row gx-2">
                            <div class="col-12 mb-3">
                                ...
                                <input class="form-control" name="name" id="name" type="text" disabled value="{{$coupon->name}}">
                                @error('name')<div class="alert alert-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12 mb-3"><label class="form-label" for="code">Mã giảm giá:</label>
                                <input class="form-control" name="code" id="code" type="text" disabled value="{{$coupon->code}}">
                            ...
                            <div class="col-12 mb-3"><label class="form-label" for="description">Mô tả:</label>
                                <textarea class="form-control" name="description" id="description" rows="3" disabled>{{$coupon->description}}</textarea>
                                @error('description')<div class="alert alert-danger">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-12 mb-3">
                                <label class="form-label" for="quantity">Số lượng:</label>
                                <input class="form-control" name="quantity" id="quantity" type="number" disabled value="{{$coupon->quantity}}">
                    ...
                    <div class="card-body">
                        <div class="row gx-2">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="date_start" name="date_start" disabled value="{{$coupon->date_start}}">
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="date_end" name="date_end" disabled value="{{$coupon->date_end}}">
                        ...
                        <div class="card-body">
                            <div class="row gx-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <input class="form-control" name="discount_amount" id="discount_amount" type="number" disabled value="{{$coupon->discount_amount}}">
