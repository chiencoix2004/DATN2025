...
@section('content')
    ...
    <form action="{{route('admin.category.update', ['id' => $danhMuc->id])}}" method="POST" enctype="multipart/form-data">
        @csrf
      @method('PUT')
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    <div class="col-md">
                        <h5 class="mb-2 mb-md-0">Update a category</h5>
                    </div>
                    <div class="col-auto">
        ...
        <div class="row g-0">
            <div class="col-lg-8 pe-lg-2">
                            ...
                            <div class="row gx-2">
                                <div class="col-12 mb-3">
                                    ...
                                    <input class="form-control"id="name" type="text" name="name"
                                        @error('name') is-invalid @enderror value="{{ old('name',$danhMuc['name']) }}" />
                                    @error('name')
                ...
                <div class="card mb-3">
                    ...
                    @enderror
                    <img src="{{ Storage::url($danhMuc->image_cover) }}" width="100" alt="">
                    {{-- <div class="card-body">
                        ...
                        <div class="row gx-2">
                            <div class="col-12 mb-3">
                                <div class="create-product-description-textarea">
                                    <textarea class="form-control" id="note" name="note" @error('note') is-invalid @enderror>{{ old('note',$danhMuc['note']) }}</textarea>
                                    @error('note')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <select class="form-select" id="parent_id" name="parent_id">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('parent_id', $danhMuc['parent_id']) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <input class="form-control" id="slug" name="slug"
                                @error('slug') is-invalid @enderror value="{{ old('slug',$danhMuc['slug']) }}"/>
                        </div>
                        @error('slug')
                            <div class="invalid-feedback">
                                {{ $message }}
    ...
    <script>
      ...
      function createSlug(value) {
          return value
              ...
              .normalize('NFD') // Chuẩn hóa các ký tự
      ...
      // Bắt sự kiện khi nhập vào trường "name"
      document.getElementById('name').addEventListener('input', function() {
          const nameInput = this.value;
          const slug = createSlug(nameInput);
          document.getElementById('slug').value = slug; // Cập nhật slug vào input slug
      });
  </script>
@endsection
