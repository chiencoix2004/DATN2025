...
@endsection
@section('contents')
    <form id="create" action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mb-3">
            <div class="card-body">
                <div class="row flex-between-center">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="submit" class="btn btn-success" id='submit-button'>Thêm tài khoản
                        </button>
                    </div>
                </div>
            </div>
