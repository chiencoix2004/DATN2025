    ...
    <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="row gx-2">
                <div class="col-4"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('theme/admin/img/generic/falcon-mode-default.jpg') }}"
                ...
                <div class="col-4"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('theme/admin/img/generic/falcon-mode-dark.jpg') }}"
                ...
                <div class="col-4"><input class="btn-check" id="themeSwitcherAuto" name="theme-color" type="radio"
                        ...
                        class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span
                            class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset('theme/admin/img/generic/falcon-mode-auto.jpg') }}"
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                    src="{{ asset('theme/admin/img/icons/left-arrow-from-left.svg') }}" width="20" alt="" />
                <div class="flex-1">
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-start"><img class="me-2"
                    src="{{ asset('theme/admin/img/icons/arrows-h.svg') }}" width="20" alt="" />
                <div class="flex-1">
        ...
        <hr />
        <div class="d-flex align-items-start"><img class="me-2"
                src="{{ asset('theme/admin/img/icons/paragraph.svg') }}" width="20" alt="" />
            <div class="flex-1">
            ...
            <div class="row gx-2">
                <div class="col-6"><input class="btn-check" id="navbar-style-transparent" type="radio"
                        ...
                        class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent"> <img
                            class="img-fluid img-prototype" src="{{ asset('theme/admin/img/generic/default.png') }}"
                ...
                <div class="col-6"><input class="btn-check" id="navbar-style-inverted" type="radio"
                        ...
                        class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted"> <img
                            class="img-fluid img-prototype" src="{{ asset('theme/admin/img/generic/inverted.png') }}"
                ...
                <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio"
                        ...
                        class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-card"> <img
                            class="img-fluid img-prototype" src="{{ asset('theme/admin/img/generic/card.png') }}"
                ...
                <div class="col-6"><input class="btn-check" id="navbar-style-vibrant" type="radio"
                        ...
                        class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-vibrant"> <img
                            class="img-fluid img-prototype" src="{{ asset('theme/admin/img/generic/vibrant.png') }}"
                            alt="" /><span class="label-text"> Vibrant</span></label></div>
            </div>
        </div>
        <div class="text-center mt-5"><img class="mb-4"
                src="{{ asset('theme/admin/img/icons/spot-illustrations/47.png') }}" alt=""
                width="120" />
