    ...
    <div class="w-100">
                            ...
                            <div class="scrollbar list py-3" style="max-height: 24rem;">
                                ...
                                <h6 class="dropdown-header fw-medium text-uppercase px-x1 fs-11 pt-0 pb-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="file-thumbnail me-2"><img
                                                ...
                                                src="{{ asset('theme/admin/img/products/3-thumb.png') }}"
                                                alt="" />
                                        </div>
                                        <div class="flex-1">
                                ...
                                <a class="dropdown-item px-x1 py-2" href="#!">
                                    <div class="d-flex align-items-center">
                                        <div class="file-thumbnail me-2"><img class="img-fluid"
                                                src="{{ asset('theme/admin/img/icons/zip.png') }}" alt="" />
                                        </div>
                                        <div class="flex-1">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-l status-online me-2">
                                            <img class="rounded-circle"
                                                src="{{ asset('theme/admin/img/team/1.jpg') }}" alt="" />
                                        </div>
                                        <div class="flex-1">
                                ...
                                <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-l me-2">
                                            <img class="rounded-circle"
                                                src="{{ asset('theme/admin/img/team/2.jpg') }}" alt="" />
                                        </div>
                                        <div class="flex-1">
                                ...
                                <a class="dropdown-item px-x1 py-2" href="pages/user/profile.html">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-l me-2">
                                            <img class="rounded-circle"
                                                src="{{ asset('theme/admin/img/team/3.jpg') }}" alt="" />
                                        </div>
                                        <div class="flex-1">
                                    ...
                                    <div class="list-group-item">
                                        <a class="border-bottom-0 notification notification-flush" href="#!">
                                            <div class="notification-avatar">
                                                <div class="avatar avatar-xl me-3">
                                                    <img class="rounded-circle"
                                                        src="{{ asset('theme/admin/img/team/10.jpg') }}"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <div class="notification-body">
        ...
        <div class="collapse navbar-collapse scrollbar py-lg-2" id="navbarDoubleTop">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.dashboard') }}" aria-haspopup="true"
