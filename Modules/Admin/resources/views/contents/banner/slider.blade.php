                    ...
                    <div class="col-xxl-9">
                            ...
                            <div class="card-body p-4">
                                ...
                                <ul class="nav nav-pills nav-justified mb-4" role="tablist">
                                    @foreach ($slider as $idbanner)
                                        @php $index = 1; @endphp
                                        <li class="nav-item">
                                            <a class="{{ $index == 1 ? 'nav-link active' : 'nav-link' }}"
                        ...
                        <div class="tab-content">
                            @foreach ($slider as $items)
                                @php $index = 1; @endphp
                                <div class="{{ $index == 1 ? 'tab-pane active' : 'tab-pane' }}"
                                        ...
                                        <div class="card-body">
                                            <div class="mb-4">
                                                ...
                                                <form action="{{ route('admin.banner.update') }}" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="image_{{ $items->id }}"
                                                            class="form-label">Ảnh</label>
                                                        <input id="image_{{ $items->id }}" name="hinh_anh"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="link_{{ $items->id }}" class="form-label">Nội
                                                            dụng</label>
                                                        <input id="link_{{ $items->id }}" name="offer_text"
                                                            type="text" class="form-control"
                                                            value="{{ $items->offer_text }}">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="link_{{ $items->id }}" class="form-label">Mô
                                                            tả</label>
                                                        <input id="link_{{ $items->id }}" name="description"
                                                            type="text" class="form-control"
                                                            value="{{ $items->description }}">
                                                    </div>
                                                    <input type="hidden" name="vi_tri"
                                                        value="{{ $items->banner_position }}">
