...
<head>
    ...
    <title>Vé được tạo thành công</title>
</head>
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <tr>
            <td style="padding: 20px;">
                <h1 style="font-size: 24px; margin-bottom: 20px; text-align: center;">Vẽ hỗ trợ tạo thành công</h1>
                <p style="margin-bottom: 20px;">{{ $data['ai_message'] }}</p>
                <p style="margin-bottom: 20px;">Đây là phản hồi tự động bằng AI, vui lòng chờ 24 - 48h để được có phản hồi mới nhất</p>
