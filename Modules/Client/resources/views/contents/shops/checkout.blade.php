            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="coupon-accordion">
                        <h3>Bạn chưa đăng nhập tài khoản? <span id="showlogin">Click ở đây để đăng nhập!</span></h3>
                        <div id="checkout-login" class="coupon-content">
                            <div class="coupon-info">
                                ...
                                <form action="javascript:void(0)">
                                    ...
                                    <p class="lost-password"><a href="javascript:void(0)">Bạn quyên mật khẩu?</a></p>
                                </form>
                            </div>
                        </div>
                        <h3>Bạn có mã giảm giá? <span id="showcoupon">Click ở đây để sử dụng mã!</span></h3>
                        <div id="checkout_coupon" class="coupon-checkout-content">
                            <div class="coupon-info">
                                <form action="javascript:void(0)">
                                    <p class="checkout-coupon">
                                        <input placeholder="Coupon code" type="text">
                                        <input class="coupon-inner_btn" value="Áp dụng mã" type="submit">
                                    </p>
                                </form>
                            </div>
                        </div>
