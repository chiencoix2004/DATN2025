                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Phương thức thanh toán:
                                    <strong>{{ $returndata['vnp_CardType'] }}</strong></p>
                ...
                <div class="d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        @elseif ($returndata['vnp_ResponseCode'] == 07)
                            ...
                            <p class="text-muted"> Bạn nhập sai mật khẩu xác thực giao dịch (OTP). Xin quý khách vui lòng
                                thực hiện lại giao dịch.</p>
                        @elseif ($returndata['vnp_ResponseCode'] == 51)
                            <p class="text-muted"> Giao dịch không thành công do: Tài khoản của quý khách không đủ số dư để
                                thực hiện giao dịch.</p>
                        @endif
                        </p>
                        <button class="btn btn-primary" onclick="window.location.href='{{ route('wallet.index') }}'">Quay
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted">Request ID:
                                <strong>{{ $returndata['vnp_SecureHash'] }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
