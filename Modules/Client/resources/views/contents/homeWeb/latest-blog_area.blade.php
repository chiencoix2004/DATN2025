            ...
            <div class="col-lg-12">
                ...
                "slidesToShow": 1
                    ...
                    <div class="blog-item">
                        <div class="blog-img img-hover_effect">
                            <a href="blog-details.html">
                                <img src="{{ asset('theme/client/images/blog/1.jpg') }}" alt="Blog Image">
                            </a>
                        </div>
                    ...
                    <div class="blog-item">
                        <div class="blog-img img-hover_effect">
                            <a href="blog-details.html">
                                <img src="{{ asset('theme/client/images/blog/2.jpg') }}" alt="Blog Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <h3 class="heading">
                    ...
                    <div class="blog-item">
                        <div class="blog-img img-hover_effect">
                            <a href="blog-details.html">
                                <img src="{{ asset('theme/client/images/blog/3.jpg') }}" alt="Blog Image">
                            </a>
                        </div>
                        <div class="blog-content">
                            <h3 class="heading">
