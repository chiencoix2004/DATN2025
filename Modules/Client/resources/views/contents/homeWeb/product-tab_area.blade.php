                ...
                <div class="section-title">
                    ...
                    <div class="product-tab">
                        <ul class="nav product-menu">
                            ...
                            <li><a data-bs-toggle="tab" href="#plaid-shirts"><span>Plaid Shirts</span></a>
                            </li>
                                    ...
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img"
                                                src="{{ asset('theme/client/images/product/5-1.jpg') }}"
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img"
                                                src="{{ asset('theme/client/images/product/6-1.jpg') }}"
                                                alt="Kenne's Product Image">
                                            <img class="secondary-img"
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img"
                                                src="{{ asset('theme/client/images/product/7-1.jpg') }}"
                                                alt="Kenne's Product Image">
                                            <img class="secondary-img"
                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img class="primary-img"
                                                src="{{ asset('theme/client/images/product/8-1.jpg') }}"
                                                alt="Kenne's Product Image">
                                            <img class="secondary-img"
